...
object HelloStageDemo extends JFXApp {
  var myButton:Button=new Button("What can I say")
...
button1.addEventHandler(MouseEvent.MOUSE_ENTERED, new EventHandler[Nothing]() {
override def handle(e: Nothing): Unit =  {
...
*/
  ...
  def updateDisplay(): Unit = {
    scanField.text.value = "look I changed"
    /*
    receiptArea.clear()
